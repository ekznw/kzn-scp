...
abstract:
    The three principal questions that guide the Ezemvelo KZN Wildlife Systematic Conservation Plan, that is, the C-Plan for the province of KwaZulu-Natal, are; 1) What biodiversity does the province contain and where is it, 2) what is the status of this biodiversity, and 3) addressed by a prioritization analysis --- where and how should conservation efforts be prioritized. This technical introduction elaborates on each of these questions that are expanded into five stages, each critical for a detailed understanding of C-Plan products.
author:
    - name: Paul Gordijn
      orcid: "0000-0002-0580-3107"
      affiliations:
        id: bspi
        name: Ezemvelo KZN Wildlife, Biodiversity, Spatial Planning and Information
    - name: Felicity Elliot
      affiliations:
        ref: bspi
    - name: Ian Rushworth
      affiliations:
      - Ezemvelo KZN Wildlife, Biodiversity, Scientific Services
    - name: Debbie Jewitt
      affiliations:
        Ezemvelo KZN Wildlife, Conservation & Research
    - name: Adrian Armstrong
      affiliations: Ezemvelo KZN Wildlife, Conservation & Research
...
format:
  html:
    toc: true
  docx: default        # actually render DOCX for this page
---

# The C-Plan --- Systematic Conservation Plan {#sec-updated-scp}

Following international protocol we structured our provincial C-Plan around these key questions [@sanbi2024mbp; @jung2025aia]:

1. What biodiversity and where is it?
2. What is the state of this biodiversity?
3. Where and how should conservation efforts be prioritized?

These questions form the basis for the structure of this C-Plan. The first key question involves collation and modelling of data in order to obtain the best available spatial representation of biodiversity. The second is largely concerned with the conservation or risk status of biodiversity that will guide the mapping of biodiversity, and the prioritization analyses in point three. 

# C-Plan stages {#sec-stages}

The main stages of the C-Plan are depicted in @fig-flow_main below.
...
1. **The what and where of biodiversity — representation data** (see ATsec-eco-state):
    ...
    a. Represent ecosystem function and change — collection of additional spatial datasets.^[If available, these data can be considered for inclusion in prioritization analysis and assessment.]
...
4. **Spatial prioritization:**
    ...
    a. Systematic spatial prioritization analyses and scenario modelling (e.g., climate change and management effectiveness).
...
The *broad-ranging* approach for representation of biodiversity in the SCP was complemented by a *targeted* approach (see @sec-spp-rep). The targeted approach required a systematic selection of species [@sanbi2024mbp]. Scientific experts on the KwaZulu-Natal Biodiversity Plan Steering Committee developed the criteria for the inclusion of species in a workshop session with external stakeholders. For the KwaZulu-Natal SCP, these criteria were applied to each grouping of taxa as shown below.
